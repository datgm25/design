...
- キシノ
  - [ ] ノベルをWeb用にビルドして、[ノベルゲームコレクション](https://novelgame.jp/)などに公開して、リンクを張る
  - [x] prac.mdを開いて、文字エンコードをUTF-8(BOMなし)にする
  - [ ] README.mdの改行が正しくできておらず、見出しが埋もれているのを修正する
  - [ ] README.mdの文字エンコードをUTF-8(BOMなし)にする
- クレバヤシ
  - [ ] ポートフォリオの作品リストに、スクリーンショット、ゲーム概要など、必要な情報を追加する
  - [ ] 開発期間と開発環境を加える
- ナガヤマ
...
- ミヤジマ OK
- ヤマダ
  - [ ] ポートフォリオに連絡先（学校で作成したgmailアドレス)を追加
